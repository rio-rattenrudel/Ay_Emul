...
#	define GCCCDECL __attribute__((regparm(3)))
#else
#	define GCCCDECL
#endif
...
extern struct SNC##CONTEXT SN##context;						  \
															  \
int		 SN##init			  (void) GCCCDECL;						   \
unsigned SN##reset			  (void) GCCCDECL;						   \
unsigned SN##exec			  (int n) GCCCDECL;						   \
int		 SN##interrupt		  (int level, int vector) GCCCDECL;		   \
void	 SN##flushInterrupts  (void) GCCCDECL;						   \
int		 SN##GetContextSize	  (void) GCCCDECL;						   \
void	 SN##GetContext		  (void *context) GCCCDECL;				   \
void	 SN##SetContext		  (void *context) GCCCDECL;				   \
int		 SN##fetch			  (unsigned address) GCCCDECL;			   \
unsigned SN##readOdometer	  (void) GCCCDECL;						   \
unsigned SN##tripOdometer	  (void) GCCCDECL;						   \
unsigned SN##controlOdometer  (int n) GCCCDECL;						   \
void	 SN##releaseTimeslice (void) GCCCDECL;						   \
unsigned SN##readPC			  (void) GCCCDECL;						   \
